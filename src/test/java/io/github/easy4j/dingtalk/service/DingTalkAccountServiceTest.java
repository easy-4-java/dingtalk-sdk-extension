...
class DingTalkAccountServiceTest {

    private DingTalkAccountService createOperations() {
        ...
        return new DingTalkAccountService(template);
    }

    @Test
    void shouldCreateInstance() {
        DingTalkAccountService ops = createOperations();
        assertNotNull(ops);
    }
}
